  ...
  selectionMode mode)
{
  ...
  if (tc->writeInternalImages)  {
	  _KLTWriteFloatImageToPGM(floatimg, "kltimg_sgfrlf.pgm", "kltimg_sgfrlf.bmp");
	  _KLTWriteFloatImageToPGM(gradx, "kltimg_sgfrlf_gx.pgm", "kltimg_sgfrlf_gx.bmp");
	  _KLTWriteFloatImageToPGM(grady, "kltimg_sgfrlf_gy.pgm", "kltimg_sgfrlf_gx.bmp");
  }
#endif
